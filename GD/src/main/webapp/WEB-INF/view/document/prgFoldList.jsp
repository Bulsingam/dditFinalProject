...
<!-- 페이징 -->
		<div class="box-footer clearfix">
			...
			<div class="pull-right">
				<form action="${pageContext.request.contextPath }/document/progressFolder.do" method="post" class="form-inline pull-right">
