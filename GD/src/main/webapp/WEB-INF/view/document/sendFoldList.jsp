				...
				<tbody id="documentList">
					<c:forEach items="${folder }" var="document">
						<tr>
							...
							<td>${document.DET_APRDATE }</td>
							<td>${document.DET_APRCONT }</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
...
<!-- 페이징 -->
		<div class="box-footer clearfix">
			...
			<div class="pull-right">
				<form action="${pageContext.request.contextPath }/document/sendFolder.do" method="post" class="form-inline pull-right">
