...
$(function(){
    ...
    $('#com_cont').summernote('code', '${comboardInfo[0].COM_CONT}');
...
<body>
	...
	<div class="box box-info">
		...
		<form class="form-horizontal"
			action="${pageContext.request.contextPath }/companyBoard/updateComboardInfo.do"
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="hidden" name="com_postnum"
							value="${comboardInfo[0].COM_POSTNUM}"> 
						<input type="hidden" name="com_writer" value="${comboardInfo[0].COM_WRITER}">
						<input type="text"
							class="form-control" name="com_title"
							value="${comboardInfo[0].COM_TITLE}" />
					</div>
				</div>
